...
int main()
{
    ...
    // Parent process
        ...
        for (i = 0; i < NUM_CONTEXT_SWITCHES; i++) {
            ...
            write(pipe1[WRITE], writeChar, strlen(writeChar) + 1);
    ...
    // Child process
        ...
        for (i = 0; i < NUM_CONTEXT_SWITCHES; i++) {
            ...
            write(pipe2[WRITE], writeChar, strlen(writeChar) + 1);

            // Send the time the context switch finished to the parent process.
